    ...
    <div class="container-fluid py-4 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-4">
            <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0" style="color:#5B463F;font-family: 'Libre Baskerville'; font-weight: bold; font-style: normal;font-size:280%;">Redes Sociais</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <div class="bg-white rounded shadow p-4 h-100" style="border-left: 4px solid #1877F2;">
                        <div class="text-center mb-4">
                            <div class="d-inline-flex align-items-center justify-content-center rounded-circle mb-3" 
                                 style="width: 70px; height: 70px; background: linear-gradient(45deg, #1877F2, #42a5f5);">
                                <i class="fab fa-facebook-f text-white fa-2x"></i>
                            </div>
                            <h4 style="font-family: 'Libre Baskerville'; color: #1877F2; margin-bottom: 0.5rem;">Facebook</h4>
                            <p class="text-muted mb-3" style="font-size: 0.9em;">Acompanhe as últimas notícias e atualizações</p>
                        </div>
                        <div class="facebook-embed">
                            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fprofile.php%3Fid%3D100087015439692&tabs=timeline&width=500&height=400&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" 
                                    width="100%" height="400" style="border:none;overflow:hidden;border-radius:8px;" scrolling="no" frameborder="0" allowfullscreen="true" 
                                    allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                        </div>
                        <div class="text-center mt-3">
                            <a href="https://www.facebook.com/profile.php?id=100087015439692" target="_blank" class="btn btn-primary btn-sm">
                                <i class="fab fa-facebook-f me-2"></i>Visitar Página
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                    <div class="bg-white rounded shadow p-4 h-100" style="border-left: 4px solid #FF0000;">
                        <div class="text-center mb-4">
                            <div class="d-inline-flex align-items-center justify-content-center rounded-circle mb-3" 
                                 style="width: 70px; height: 70px; background: linear-gradient(45deg, #FF0000, #ff5722);">
                                <i class="fab fa-youtube text-white fa-2x"></i>
                            </div>
                            <h4 style="font-family: 'Libre Baskerville'; color: #FF0000; margin-bottom: 0.5rem;">YouTube</h4>
                            <p class="text-muted mb-3" style="font-size: 0.9em;">Vídeos educativos e eventos ao vivo</p>
                        </div>
                        <div class="youtube-placeholder text-center">
                            <div class="border rounded p-4" style="min-<?php
// Incluir configuração e funções
...
try {
    ...
    // Buscar próximos eventos (incluindo eventos do dia atual)
    $stmt = $pdo->prepare("SELECT * FROM agenda WHERE DATE(data_evento) >= CURDATE() AND ativo = 1 ORDER BY data_evento ASC LIMIT 3");
    $stmt->execute();
    $proximos_eventos = $stmt->fetchAll();
    
    // Se não há eventos futuros, buscar os 3 mais recentes
    if (empty($proximos_eventos)) {
        $stmt = $pdo->prepare("SELECT * FROM agenda WHERE ativo = 1 ORDER BY data_evento DESC LIMIT 3");
        $stmt->execute();
        $proximos_eventos = $stmt->fetchAll();
    }
        ...
        <div class="container py-4">
            ...
            <div class="row g-5">
                ...
                foreach ($noticias_destaque as $noticia): 
                    // Gerar URL absoluta para o artigo
                    $artigo_url = "https://oagb.gw/artigo.php?slug=" . urlencode($noticia->slug);
                ?>
                    ...
                    <div class="blog-item bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4" style="padding:0px">
                            <h4 class="mb-3" style="margin:0px;color:#4D1C21;font-family: 'Libre Baskerville'; font-weight: normal; font-style: normal;font-size:180%;">
                                <a href="<?php echo $artigo_url; ?>" class="linkSublinhado" style="color:#4D1C21;">
                            ...
                            <span id="" style="border-bottom:1px solid #111923;float:left;">
                                <a class="text-uppercase" href="<?php echo $artigo_url; ?>">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="container-fluid py-4 wow fadeInUp" data-wow-delay="0.1s" style="background: #f8f9fa;">
        <div class="container py-4">
            <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0" style="color:#5B463F;font-family: 'Libre Baskerville'; font-weight: bold; font-style: normal;font-size:280%;">Agenda</h1>
            </div>
            ...
            <div class="row g-4">
                ...
                foreach ($proximos_eventos as $evento): 
                    // Gerar URL absoluta para o evento
                    $evento_url = "https://oagb.gw/evento.php?slug=" . urlencode($evento->slug);
                ?>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="<?php echo $delay; ?>s">
                    <div class="bg-white rounded shadow-sm p-4 h-100">
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div class="flex-grow-1">
                                <h5 class="mb-1" style="font-family: 'Libre Baskerville'; color: #4D1C21;">
                                    <a href="<?php echo $evento_url; ?>" class="text-decoration-none" style="color: #4D1C21;">
                        ...
                        <p class="text-muted mb-2" style="font-family: 'Open Sans'; font-size: 0.9em;">
                            <i class="fa fa-map-marker-alt me-2 text-primary"></i><?php echo htmlspecialchars($evento->local_evento); ?>
                        </p>
                        <?php endif; ?>
                        <?php if (!empty($evento->descricao)): ?>
                        <p style="font-family: 'Open Sans'; color: #111923;"><?php echo htmlspecialchars(truncate_text($evento->descricao, 100)); ?></p>
                        <?php endif; ?>
                        <div class="mt-3">
                            <a href="<?php echo $evento_url; ?>" class="btn btn-outline-primary btn-sm">
            ...
            <div class="text-center">
                <div class="bg-white rounded shadow-sm p-5">
                    ...
                    <h5 class="text-muted">Nenhum evento agendado</h5>
                    <p class="text-muted">Consulte novamente em breve para ver os próximos eventos da OAGB.</p>
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                    <div class="bg-light rounded p-4 h-100">
                        ...
                        <div class="youtube-placeholder text-center">
                            <div class="border rounded p-4" style="min-height: 350px; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border-radius: 8px;">
                                <div>
                                    <div class="mb-4">
                                        <i class="fab fa-youtube text-muted fa-4x"></i>
                                    </div>
                                    <h5 class="text-muted mb-3">Canal YouTube</h5>
                                    <p class="text-muted mb-4">Canal em desenvolvimento<br>Em breve conteúdo exclusivo!</p>
                                    <div class="d-flex flex-column gap-2">
                                        <button class="btn btn-outline-danger disabled" style="cursor: not-allowed;">
                                            <i class="fab fa-youtube me-2"></i>Inscrever-se
                                        </button>
                                        <small class="text-muted">Disponível em breve</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center mt-3">
                            <div class="row text-center">
                                <div class="col-4">
                                    <div class="p-2">
                                        <strong class="d-block text-danger">0</strong>
            ...
            <div class="text-center mt-4">
                <div class="d-flex justify-content-center gap-3">
                    <a href="https://www.facebook.com/profile.php?id=100087015439692" target="_blank" class="btn btn-outline-primary">
