                    ...
                    <div class="blog-item bg-light rounded overflow-hidden h-100">
                        <div class="blog-img position-relative overflow-hidden">
                            <?php if ($noticia->imagem_destaque): ?>
                                <img class="img-fluid w-100" src="img/noticias/<?php echo htmlspecialchars($noticia->imagem_destaque); ?>" alt="<?php echo htmlspecialchars($noticia->titulo); ?>" style="height: 250px; object-fit: cover;">
                            <?php else: ?>
