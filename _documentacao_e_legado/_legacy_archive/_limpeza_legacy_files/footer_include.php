<!-- Newsletter Banner -->
<!-- <div class="container-fluid" style="background: url('img/Asset 6-100.jpg') center/cover;">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <a href="#"><img src="img/Asset 6-100.jpg" style="width:100%;height:auto;" class="img-fluid" alt="Newsletter Banner"></a>
            </div>
        </div>
    </div>
</div> -->
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="text-dark mb-0" style="font-family: 'Open Sans', sans-serif !important; color: #5B463F !important;">Fale connosco</h3>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="text-dark mb-0" style="font-family: 'Open Sans', sans-serif !important; color: #5B463F !important;">Institucional</h3>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="text-dark mb-0" style="font-family: 'Open Sans', sans-serif !important; color: #5B463F !important;">Advogados</h3>
                        </div>
                        <div class="link-animated d-flex flex-column justify-content-start">
