                            ...
                            <?php foreach ($por_ano as $ano => $edicoes): ?>
                                ...
                                <div class="doc-list mb-5">
                                    <?php foreach ($edicoes as $rev): ?>
                                        <?php 
                                            $file_link = !empty($rev->arquivo_pdf) ? 'uploads/revistas/' . htmlspecialchars($rev->arquivo_pdf) : '#';
                                        ?>
                                        <div class="doc-card wow fadeInUp">
                                            ...
                                            <div class="doc-content">
                                                ...
                                                <div class="doc-meta">
                                                    <span><i class="far fa-calendar-alt"></i> <?php echo date('d/m/Y', strtotime($rev->data_publicacao)); ?></span>
                                                    <?php if(!empty($rev->edicao)): ?>
                                                        <span><i class="fas fa-hashtag"></i> <?php echo htmlspecialchars($rev->edicao); ?></span>
                                                    <?php endif; ?>
                                                </div>
                                                <?php if(!empty($rev->descricao)): ?>
                                                    <p class="text-muted" style="font-size:0.9rem; margin-bottom:15px;"><?php echo nl2br(htmlspecialchars($rev->descricao)); ?></p>
                                                <?php endif; ?>
                                                <div>
