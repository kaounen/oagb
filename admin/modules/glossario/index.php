...
try { $items = $pdo->query("SELECT * FROM glossario_juridico ORDER BY letra ASC, termo ASC")->fetchAll(); } catch (PDOException $e) { $items = []; }
?>
<div class="row mb-5 align-items-center">
    <div class="col-md-6"><h2 class="page-title">Glossário Jurídico</h2><div class="text-muted small">Gerir termos e definições jurídicas (<?php echo count($items); ?> termos).</div></div>
    <div class="col-md-6 text-md-end mt-3 mt-md-0"><a href="add.php" class="btn btn-login w-auto px-4"><i class="fas fa-plus me-2"></i>Novo Termo</a></div>
</div>
<div class="card border-0 shadow-sm"><div class="card-body p-0"><div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
        <thead class="bg-light"><tr>
            <th class="ps-4 border-0 small text-uppercase" style="width:50px;">L</th>
            <th class="border-0 small text-uppercase">Termo</th>
            <th class="border-0 small text-uppercase">Tipo</th>
