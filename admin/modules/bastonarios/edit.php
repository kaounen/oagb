...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("UPDATE bastonarios SET nome_completo = ?, biografia = ?, foto_url = ?, data_inicio_mandato = ?, data_fim_mandato = ?, email_contacto = ?, is_atual = ? WHERE id = ?");
        $stmt->execute([$nome, $biografia, $foto, $inicio, $fim, $email, $is_atual, $id]);
