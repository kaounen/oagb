...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO timeline_marcos (ano, titulo, descricao, imagem, ordem) VALUES (?, ?, ?, ?, ?)");
        $stmt->execute([$ano, $titulo, $desc, $img, $ordem]);
...
<div class="row mb-5 align-items-center">
    <div class="col-md-6">
        <h2 class="page-title"><a href="index.php" class="text-decoration-none text-muted"><i class="fas fa-arrow-left me-2"></i></a> Registar Marco Histórico</h2>
    </div>
</div>
    ...
    <form method="POST" enctype="multipart/form-data">
        <div class="row g-4 mb-4">
            <div class="col-md-2">
                ...
                <input type="text" name="ano" class="form-control border-0 bg-light p-3 fs-5" required placeholder="Ex: 1991">
            </div>
            <div class="col-md-10">
                <label class="form-label small fw-bold text-muted">Título do Marco Histórico</label>
                <input type="text" name="titulo" class="form-control border-0 bg-light p-3 fs-5" required placeholder="Ex: Fundação da Ordem dos Advogados">
            </div>
        </div>
        ...
        <div class="row align-items-center g-4">
            ...
            <div class="col-md-2">
                ...
                <input type="number" name="ordem" class="form-control border-0 bg-light p-3" value="0">
            </div>
            
            <div class="col-md-4 text-md-end">
                <button type="submit" class="btn btn-login w-auto px-5 py-3 shadow-lg fs-6 fw-bold text-uppercase">Publicar na Timeline</button>
            </div>
        </div>
    </form>
</div>
