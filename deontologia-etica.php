            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    <?php if (count($seccoes) > 0): ?>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <div class="text-center py-5"><i class="fas fa-balance-scale" style="font-size:3rem;color:#dcd8cf;"></i><h5 style="color:var(--primary-maroon);font-family:'Libre Baskerville';">Conteúdo em preparação</h5></div>
                    <?php endif; ?>
                </div>
                <div class="col-lg-4 mt-5 mt-lg-0 pt-lg-4">
                    <div class="sidebar-widget shadow-sm">
                        ...
                        <div class="mt-3">
                            ...
                            <a href="deontologia-etica.php" class="sidebar-link active"><i class="fas fa-balance-scale"></i> Deontologia e Ética</a>
                            <a href="centro-estagio.php" class="sidebar-link"><i class="fas fa-graduation-cap"></i> Centro de Estágio</a>
