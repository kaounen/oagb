...
$page_title = "Pareceres e Deliberações";
$meta_description = "Documentação oficial, pareceres e deliberações da Ordem dos Advogados da Guiné-Bissau.";
$header_image = 'uploads/truth-concept-arrangement-with-balance-ouro.jpg';

try {
    $stmt = $pdo->prepare("SELECT * FROM documentos_publicos WHERE tipo IN ('parecer', 'deliberacao') AND ativo = 1 ORDER BY data_documento DESC");
    $stmt->execute();
        ...
        <div class="container py-lg-3">
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <p class="lead mb-5" style="color: #444;">Consulte os documentos oficiais emitidos e aprovados pela Ordem dos Advogados da Guiné-Bissau. A transparência e o acesso à informação são pilares da nossa instituição.</p>
                                ...
                                <div class="doc-list mb-5">
                                    <?php foreach ($docs_do_ano as $doc): ?>
                                        <?php 
                                            ...
                                            $detail_page = ($doc->tipo === 'parecer') ? 'parecer.php' : 'deliberacao.php';
                                        ?>
                                        <div class="doc-card wow fadeInUp">
                                            <div class="doc-icon"><i class="fas fa-gavel"></i></div>
                                            <div class="doc-content">
                                                <h4 class="doc-title">
                                                    <a href="<?php echo $detail_page; ?>?id=<?php echo $doc->id; ?>">
                                                ...
                                                <?php if($doc->descricao): ?>
                                                    <p class="text-muted" style="font-size:0.9rem; margin-bottom:15px;">
                                                        <?php 
                                                            $resumo_doc = strip_tags($doc->descricao);
                                                            if(mb_strlen($resumo_doc) > 200) {
                                                                echo htmlspecialchars(mb_substr($resumo_doc, 0, 200)) . '...';
                                                            } else {
                                                                echo htmlspecialchars($resumo_doc);
                                                            }
                                                        ?>
                                                    </p>
                                                <?php endif; ?>
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    <a href="<?php echo $detail_page; ?>?id=<?php echo $doc->id; ?>" class="btn-download" style="background: var(--primary-gold);">
                                                        <i class="far fa-eye"></i> Ler Documento
                                                    </a>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0 pt-lg-4">
                    <div class="sidebar-widget shadow-sm sticky-top" style="top: 150px;">
                        <div class="mt-0">
                            <a href="pareceres-deliberacoes.php" class="sidebar-link active"><i class="fas fa-gavel"></i> Pareceres e Deliberações</a>
