                            ...
                            <?php foreach ($documentos as $doc): ?>
                                <div class="doc-card wow fadeInUp">
                                    ...
                                    <div class="doc-content">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo (!empty($doc->arquivo) && $doc->arquivo != '#') ? 'uploads/documentos/' . htmlspecialchars($doc->arquivo) : '#'; ?>" target="_blank" class="btn-download"><i class="fas fa-download"></i> Descarregar Documento</a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
