...
<head>
    ...
    <style>
        ...
        body { font-family: 'Open Sans', sans-serif; background-color: #fafafa; overflow-x: hidden; }
        
        html, body { overflow-x: hidden !important; max-width: 100vw; }

        /* === SUBPAGE BREADCRUMB BAR (Header creme - igual a-ordem-dos-advogados) === */
        ...
        .subpage-breadcrumb-bar a:hover { color: var(--primary-maroon); }
        .subpage-breadcrumb-bar .bc-active { color: var(--primary-maroon) !important; font-weight: 600; }
        .bc-sep { display: inline-block; width: 5px; height: 5px; background: var(--primary-gold); border-radius: 50%; margin: 0 10px; vertical-align: middle; }

        .quick-links a {
            width: 36px; height: 36px; border-radius: 50%; border: 1px solid var(--primary-maroon);
            display: inline-flex; align-items: center; justify-content: center;
            color: var(--primary-maroon) !important; transition: .3s; font-size: 0.85rem;
        }
        ...
        /* === MOBILE HEADER SIMPLE (Sem carousel) === */
        @media (max-width: 991px) {
            ...
            #mobile-header-simple .mobile-header-contacts {
                background: var(--light-bg) !important;
            }
            #mobile-header-simple .mobile-header-contacts small {
                color: var(--primary-maroon) !important;
                font-size: 0.70rem;
            }
            #mobile-header-simple .mobile-header-contacts i {
                color: var(--primary-maroon) !important;
            }
            #mobile-header-simple .mobile-pill-btn {
                color: var(--primary-maroon) !important;
                border-color: var(--primary-maroon) !important;
                background: transparent !important;
            }
            #mobile-header-simple .mobile-pill-btn i {
                color: var(--primary-maroon) !important;
            }
            ...
            #mobile-header-simple .dropdown-menu {
                background: rgba(255, 255, 255, 0.98) !important;
                backdrop-filter: blur(10px);
            }
            #mobile-header-simple .mobile-breadcrumb-bar {
                background: var(--light-bg) !important;
                border-bottom: 1px solid #e0dcd2;
            }
            #mobile-header-simple .mobile-breadcrumb-bar a,
            #mobile-header-simple .mobile-breadcrumb-bar span {
                color: #666 !important;
                font-size: 0.72rem;
            }
            #mobile-header-simple .mobile-breadcrumb-bar .bc-active {
                color: var(--primary-maroon) !important;
                font-weight: 600;
            }
            #mobile-header-simple .mobile-breadcrumb-bar .quick-links a {
                border-color: var(--primary-maroon) !important;
                color: var(--primary-maroon) !important;
                width: 30px;
                height: 30px;
            ...
            #mobile-header-simple .mobile-breadcrumb-bar .quick-links a:hover {
                background: rgba(77,28,33,0.08) !important;
                border-color: var(--primary-gold) !important;
            }
...
<body>
    ...
    <!-- Desktop Header (Igual a-ordem-dos-advogados.php - fundo creme, sem imagem) -->
    <div class="container-fluid position-relative p-0 d-none d-lg-block">
        <?php include 'includes/navbar.php'; ?>
        <div class="container-fluid" style="min-height: 400px; background: #f7f5f0; display: flex; align-items: flex-end; padding-bottom: 0;">
    ...
    <!-- Mobile Header Simples (Sem carousel - igual a-ordem estrutura) -->
    <div class="d-block d-lg-none">
        <div id="mobile-header-simple">
            <!-- Contacts -->
                ...
                <div class="row g-0 mb-1">
                    <div class="col-12 d-flex justify-content-center align-items-center gap-3">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu m-0 border-0 rounded-3 shadow-lg p-1 dropdown-menu-center" style="min-width: 150px; z-index: 2050; margin-top: 10px;">
    ...
    <style>
        ...
        .bast-profile-card:hover {
            box-shadow: 0 15px 50px rgba(177, 162, 118, 0.15);
        ...
        .bast-content .btn-cv:hover {
            background: #3a1519;
            color: #fff;
            transform: translateY(-2px);
            box-shadow: 0 6px 20px rgba(77,28,33,0.3);
        }
        ...
        .bastonario-card:hover {
            box-shadow: 0 8px 25px rgba(177, 162, 118, 0.12);
        ...
        .bastonario-card .periodo {
            font-size: 0.8rem;
            color: #999;
        }
        .bastonario-card .bio-extra {
            display: none;
            font-size: 0.8rem;
            color: #666;
            text-align: justify;
    ...
    <script>
        $(document).ready(function() {
            ...
            fixHorizontalScroll();
            $(window).on('resize', fixHorizontalScroll);
        });
    </script>
</body>
</html>
