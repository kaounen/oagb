                ...
                <div class="carousel-item <?php echo $first ? 'active' : ''; ?>">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="text-white mb-md-4" style="font-family: 'Libre Baskerville', serif;">
                                <?php echo htmlspecialchars($slide->titulo); ?>
                            </h1>
                            <h5 class="text-white mb-3" style="font-family: 'Open Sans', sans-serif;">
    ...
    <div class="container-fluid py-4" style="background: #f8f9fa;">
        <div class="container py-4">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="agenda-evento">
                        ...
                        <img src="uploads/<?php echo htmlspecialchars($evento->imagem_destaque); ?>" 
            ...
            <!-- <div class="text-center mt-4">
                <a href="agenda.php" class="d-inline-block">
                    <div class="btn-arrow-only" style="max-width: 350px;">
                        <i class="bi bi-arrow-right"></i>
                    </div>
                </a>
            </div> -->
