...
if (!function_exists('oagb_fix_encoding')) {
    function oagb_fix_encoding($text) {
        ...
        $fixed_text = str_replace(['├¥├Æ', '├¥', '├Ü', '├Æ'], ['├º├úo', '├º', '├®', '├ú'], $text);
...
$page_title = "A Ordem"; 
$meta_description = "Conhe├ºa a hist├│ria, miss├úo e valores da Ordem dos Advogados da Guin├®-Bissau";
            ...
            <div class="subpage-breadcrumb-bar w-100" style="margin-bottom: 10px;">
                <div class="container d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <span class="bc-sep"></span>
                        <span class="bc-active">Apresenta├º├úo</span>
                    </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="mobile-header-contacts container-fluid px-1 pt-3 pb-1">
                        <div class="row mb-3">
                            <div class="col-12" style="display: flex !important; flex-direction: row !important; flex-wrap: nowrap !important; justify-content: center !important; align-items: center !important; gap: 8px; overflow-x: auto; width: 100%;">
                                <small class="text-white text-nowrap" style="font-size: 0.70rem;"><i class="fa fa-map-marker-alt text-white-50 me-1"></i>Bissau, Guin├®-Bissau</small>
                            ...
                            <div class="col-12" style="display: flex !important; flex-direction: row !important; flex-wrap: nowrap !important; justify-content: center !important; align-items: center !important; gap: 12px; width: 100%;">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu m-0 border-0 rounded-3 shadow-lg p-1 dropdown-menu-center" style="min-width: 150px; z-index: 2000; margin-top: 10px; background: rgba(255, 255, 255, 0.98); backdrop-filter: blur(10px); position: absolute; left: 50%; transform: translateX(-50%); right: auto;">
                                        <a href="#" onclick="changeLanguage('pt'); return false;" class="dropdown-item py-1 d-flex align-items-center rounded-2 mb-0" style="transition: .3s; font-size: 0.8rem;"><span class="me-3" style="font-size: 1.1rem;">­ƒçÁ­ƒç╣</span> <span class="text-dark">Portugu├¬s</span></a>
                                        <a href="#" onclick="changeLanguage('en'); return false;" class="dropdown-item py-1 d-flex align-items-center rounded-2 mb-0" style="transition: .3s; font-size: 0.8rem;"><span class="me-3" style="font-size: 1.1rem;">­ƒç║­ƒç©</span> <span class="text-dark">English</span></a>
                                        <a href="#" onclick="changeLanguage('fr'); return false;" class="dropdown-item py-1 d-flex align-items-center rounded-2 mb-0" style="transition: .3s; font-size: 0.8rem;"><span class="me-3" style="font-size: 1.1rem;">­ƒç½­ƒçÀ</span> <span class="text-dark">Fran├ºais</span></a>
                                        <a href="#" onclick="changeLanguage('es'); return false;" class="dropdown-item py-1 d-flex align-items-center rounded-2 mb-0" style="transition: .3s; font-size: 0.8rem;"><span class="me-3" style="font-size: 1.1rem;">­ƒç¬­ƒç©</span> <span class="text-dark">Espa├▒ol</span></a>
                                        <a href="#" onclick="changeLanguage('ar'); return false;" class="dropdown-item py-1 d-flex align-items-center rounded-2 mb-0" style="transition: .3s; font-size: 0.8rem;"><span class="me-3" style="font-size: 1.1rem;">­ƒç©­ƒçª</span> <span class="text-dark">Ïº┘äÏ╣Ï▒Ï¿┘èÏ®</span></a>
                                        <a href="#" onclick="changeLanguage('zh-CN'); return false;" class="dropdown-item py-1 d-flex align-items-center rounded-2 mb-0" style="transition: .3s; font-size: 0.8rem;"><span class="me-3" style="font-size: 1.1rem;">­ƒç¿­ƒç│</span> <span class="text-dark">õ©¡µûç</span></a>
                                        <a href="#" onclick="changeLanguage('ru'); return false;" class="dropdown-item py-1 d-flex align-items-center rounded-2" style="transition: .3s; font-size: 0.8rem;"><span class="me-3" style="font-size: 1.1rem;">­ƒçÀ­ƒç║</span> <span class="text-dark">ðáÐâÐüÐüð║ð©ð╣</span></a>
                                    </div>
                                </div>
                    ...
                    <div class="carousel-caption ordem-mobile-caption d-flex flex-column align-items-center justify-content-end" style="padding: 0 1rem; min-height: 80px;">
                        <!-- O t├¡tulo foi removido a pedido do utilizador para esta p├ígina mobile -->
                    </div>
                    ...
                    <div class="header-overlay-bar mobile-breadcrumb-bar">
                        <div class="container d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <span>A Ordem</span>
                                <span class="dot-sep" style="width: 4px; height: 4px; background: rgba(255,255,255,0.7); display: inline-block; border-radius: 50%; margin: 0 10px; vertical-align: middle;"></span>
                                <span class="bc-active" style="color: #fff; font-weight: 500;">Apresenta├º├úo</span>
                            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="mvv-card d-flex align-items-start gap-3 h-100">
                        ...
                        <div>
                            <h6 class="mb-2 fw-bold" style="color: var(--primary-maroon); font-family: 'Libre Baskerville', serif; font-size: 1rem;">Miss├úo</h6>
                            <p class="mvv-text mb-0">
                                <?php echo oagb_fix_encoding($inst_info->missao ?? 'Defender os direitos, liberdades e garantias dos cidad├úos.'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mvv-card d-flex align-items-start gap-3 h-100">
                        ...
                        <div>
                            <h6 class="mb-2 fw-bold" style="color: var(--primary-maroon); font-family: 'Libre Baskerville', serif; font-size: 1rem;">Vis├úo</h6>
                            <p class="mvv-text mb-0">
                                <?php echo oagb_fix_encoding($inst_info->visao ?? 'Ser refer├¬ncia na defesa da legalidade democr├ítica.'); ?>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mvv-card d-flex align-items-start gap-3 h-100">
                        ...
                        <div>
                            ...
                            <p class="mvv-text mb-0">
                                <?php echo oagb_fix_encoding($inst_info->valores ?? 'Independ├¬ncia, Isen├º├úo, Sigilo Profissional.'); ?>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-3 mt-4 justify-content-center">
                ...
                <div class="col-6 col-lg-3">
                    <div class="info-card text-center py-3 px-2">
                        ...
                        <small class="d-block text-muted mt-1" style="font-size: 0.72rem; text-transform: uppercase; letter-spacing: 1px;">Estagi├írios Ativos</small>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="pt-3 pb-3" style="background: #f7f5f0;">
        <div class="container py-lg-3">
            <div class="text-center mb-5">
                ...
                <h2 class="section-heading">Marcos Hist├│ricos</h2>
            </div>
            ...
            <div class="tl-container">
                ...
                <?php else: ?>
                    <div class="text-center py-5">
                        <p class="text-muted">A preparar os marcos hist├│ricosÔÇª</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="texto-conteudo mb-4" style="max-width: 600px; margin: 0 auto; font-size: 0.85rem; line-height: 1.7;">
                        Os Estatutos definem a organiza├º├úo, os deveres e os direitos dos advogados inscritos na Ordem. Consulte o documento integral aprovado em Assembleia Geral.
                    </p>
    ...
    <script>
        function sharePage() {
            if (navigator.share) {
                navigator.share({
                    title: 'OAGB - A Ordem',
                    text: 'Conhe├ºa a Ordem dos Advogados da Guin├®-Bissau',
                    url: window.location.href
                }).catch(() => {});
            } else {
                navigator.clipboard.writeText(window.location.href);
                alert('Liga├º├úo copiada!');
            }
        }
