<?php
/**
 * Header Variante C: Simples (sem slider, sem foto)
 * Usado em: agenda.php, noticias.php e outras páginas de conteúdo
 * 
 * Características:
 * - Sem foto de fundo
 * - Sem slider
...
<!-- Desktop Header Variant C Start -->
<div class="container-fluid position-relative p-0 d-none d-lg-block">
    <?php include 'navbar.php'; ?>

    <!-- Header Content without Background Image -->
    <div class="bg-header-simple">
        <div class="container">
            <div class="row g-5 align-items-center" style="display: flex; align-items: center; justify-content: center; min-height: 200px;">
...
<!-- Desktop Header Variant C End -->

<!-- Mobile Header Variant C Start -->
<div class="d-lg-none">
    <!-- Mobile Background without Image -->
    <div class="mobile-header-simple" style="background: linear-gradient(135deg, #091E3E 0%, #1a3a5c 100%); min-height: 35vh; position: relative;">
        ...
        <div style="position: absolute; bottom: 20px; left: 0; right: 0; z-index: 500; padding: 1rem 1.5rem; text-align: center; display: flex; flex-direction: column; align-items: center; justify-content: center;">
            <!-- Breadcrumbs -->
            <?php if (!empty($breadcrumbs)): ?>
...
<!-- Mobile Header Variant C End -->

<style>
    /* Header Variant C Styles */
    .bg-header-simple {
