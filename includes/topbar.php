<!-- Topbar Start -->
<div id="topbar" class="container-fluid topbar d-none d-lg-block px-5">
    <div class="row gx-0 align-items-center">
        <div class="col-lg-7 text-start ps-1 topbar-contacts">
        ...
        <div class="col-lg-5 text-end pe-1">
            <div class="d-inline-flex align-items-center" style="height: 40px; gap: 12px;">
