...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $pdo->prepare("INSERT INTO biblioteca_oagb (titulo, autor, categoria, capa, ficheiro, ano_publicacao, resumo, link_externo, status, destaque) VALUES (?,?,?,?,?,?,?,?,?,?)")
            ->execute([$titulo, $autor, $cat, $capa, $ficheiro, $ano ?: null, $resumo, $link, $status, $destaque]);
...
<div class="row mb-4">
    <div class="col">
        <h2 class="page-title">Nova Obra</h2>
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="categoria" class="form-control" required placeholder="Ex: Doutrina, Legislação">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="destaque" id="destaqueCheck">
                ...
                <div class="col-12">
                    ...
                    <textarea name="resumo" id="editor" class="form-control" rows="5"></textarea>
                </div>
                
                <div class="col-12 mt-4">
                    <button type="submit" class="btn btn-login px-5 py-2"><i class="fas fa-save me-2"></i>Guardar Obra</button>
                </div>
            </div>
        </form>
    </div>
