...
// Fetch trainees for selected letter
$stmt = $pdo->prepare("SELECT numero_registo, nome_completo, regiao, localidade, telefone, email, data_inicio_estagio, foto 
...
$alfabeto = range('A', 'Z');
$contagem = [];
$stmt_count = $pdo->prepare("SELECT COUNT(*) FROM advogados_estagiarios WHERE status = 'ativo' AND nome_completo LIKE ?");
